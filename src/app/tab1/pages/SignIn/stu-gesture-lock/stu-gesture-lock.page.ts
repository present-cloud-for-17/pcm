...
@Component({
  selector: 'app-stu-gesture-lock',
  templateUrl: './stu-gesture-lock.page.html',
  styleUrls: ['./stu-gesture-lock.page.scss'],
})

export class StuGestureLockPage implements OnInit {

  height = 320;
  width = 320;
  chooseType = 3;
  devicePixelRatio: any; // 设备密度
  titleMes = '手势密码解锁';
  ...
  setInteralFun(time: any) { // 检查是否超过设定时间
    this.lockTime = time;
